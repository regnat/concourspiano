...
<head profile="http://www.w3.org/2006/03/hcard">
   ...
   <title>29ème concours de piano amateur de l'&Eacute;cole polytechnique</title>
...
<body id="page-home" class="">
   ...
   <div id="main">
	    <h2 id="tagline">29<sup>ème</sup> Concours international de piano amateur de l'&Eacute;cole polytechnique</h2>
   ...
   <div id="scroller-window">
	 ...
	 <div id="scroller-programme-window">
	 <div id="scroller-programme-wrap">		
			
		  <div class="project">
			
			<h3 class="title">Programme</h3> 
			<div class="text">
			   <?php include('contenu/programme.html');?>
			</div>
		  </div><!-- .project -->	


	 </div><!-- #scroller-programme-wrap -->
	 </div><!-- #scroller-programme-window -->
