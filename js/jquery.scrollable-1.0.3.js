/**
 * jquery.scrollable 1.0.3 - Scroll your HTML with eye candy.
 * 
...
(function($) {
	...
	$.tools.version.scrollable = '1.0.3';
	...
	function Scrollable(root, conf) {   
		...
		$.extend(self, {
			...
			setPage: function(page, time, fn) {
				var size = conf.size;
				var index = size * page;
				//THE BELOW LINES NEED TO BE COMMENTED OUT TO AVOID A BUG WHEN PAGE SIZE = 1
